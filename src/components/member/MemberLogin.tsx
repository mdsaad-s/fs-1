...
import { Mail, Lock, LogIn, Eye, EyeOff, AlertCircle, Shield, Sparkles, ArrowLeft } from "lucide-react";
...
const MemberLogin = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Find member user only (not admin)
    ...
    if (user) {
      if (user.status === "active") {
        ...
        localStorage.setItem("token", "member-token-" + Date.now());
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-500 to-indigo-300">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-indigo-500 p-6 lg:p-8 flex flex-col justify-center items-center text-center">
              ...
              {/* Logo */}
              <div className="mb-4">
                <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center mx-auto backdrop-blur-sm border border-gray-300">
            ...
            <div className="p-8 lg:p-10 bg-sky-100">
  ...
  <a href="/forgot-password" className="text-sm text from-gray-900 to-indigo-500 hover:text from-gray-900 to-indigo-500 hover:underline">
    Forgot password?
  </a>
</div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600">
                    ...
                    <a href="/register" className="font-semibold text from-gray-900 to-indigo-500 hover:text from-gray-900 to-indigo-500 hover:underline">
                      Register here
                    </a>
                  </p>
                </div>
                ...
                <div className="mt-6 p-3 bg-sky-50 rounded-lg border border-sky-100">
                  <p className="text-xs text-sky-700 text-center font-medium mb-2"></p>
